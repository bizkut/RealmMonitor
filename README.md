...
- 🐦 **Bluesky Integration** — optionally receive posts from three official Blizzard profiles directly in Telegram:
  - **Support Feed** (`support.blizzard.com`) alerts for server maintenance and outages.
  - **Official WoW Feed** (`worldofwarcraft.blizzard.com`) for retail announcements.
  - **Classic Devs Feed** (`wowclassicdevs.blizzard.com`) for WoW Classic ecosystem updates.
